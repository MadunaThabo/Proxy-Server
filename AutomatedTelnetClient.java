...
public class AutomatedTelnetClient implements Runnable, TelnetNotificationHandler {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        while (true) {
            ...
            try {
                ...
                final Thread reader = new Thread(new AutomatedTelnetClient());
                tc.registerNotifHandler(new AutomatedTelnetClient());
                            ...
                            if (lines != null) {
                                for (int i = 0; i < lines.length; i++) {
                                    for (int j = 0; j < lines[i].length(); j++) {
                                        if (lines[i].charAt(j) == 'A' && lines[i].charAt(j + 1) == 'Y'
                                                && lines[i].charAt(j + 2) == 'T') {
                                            ...
                                            j+=3;
                                        } else if (lines[i].charAt(j) == 'O' && lines[i].charAt(j + 1) == 'P'
                                                && lines[i].charAt(j + 2) == 'T') {
                                            ...
                                            j+=3;
                                        } else if (lines[i].charAt(j) == 'R' && lines[i].charAt(j + 1) == 'E'
                                                && lines[i].charAt(j + 2) == 'G' && lines[i].charAt(j + 3) == 'I'
                                                && lines[i].charAt(j + 4) == 'S' && lines[i].charAt(j + 5) == 'T'
                                                && lines[i].charAt(j + 6) == 'E' && lines[i].charAt(j + 7) == 'R') {
                                                    j+=7;
                                            ...
                                            try {
                                                ...
                                                final SimpleOptionHandler opthand = new SimpleOptionHandler(opcode,
                                                        initlocal,
                                                        initremote,
                                        ...
                                        } else if (lines[i].charAt(j) == 'U' && lines[i].charAt(j + 1) == 'N'
                                                && lines[i].charAt(j + 2) == 'R'
                                                && lines[i].charAt(j + 3) == 'E'
                                                && lines[i].charAt(j + 4) == 'G' && lines[i].charAt(j + 5) == 'I'
                                                && lines[i].charAt(j + 6) == 'S' && lines[i].charAt(j + 7) == 'T'
                                                && lines[i].charAt(j + 8) == 'E' && lines[i].charAt(j + 9) == 'R') {
                                            ...
                                            j+=10;
                                        } else if (lines[i].charAt(j) == 'S' && lines[i].charAt(j + 1) == 'P'
                                                && lines[i].charAt(j + 2) == 'Y') {
                                                    
                                            tc.registerSpyStream(fout);
                                            j+=3;
                                        } else if (lines[i].charAt(j) == 'U' && lines[i].charAt(j + 1) == 'N'
                                                && lines[i].charAt(j + 2) == 'S'
                                                && lines[i].charAt(j + 3) == 'P'
                                                && lines[i].charAt(j + 4) == 'Y') {
                                            ...
                                            outstr.flush();
                                        } else if (lines[i].charAt(j) == 'p' && lines[i].charAt(j+1) == 's') {
                                            
                                            System.out.println("This command is restricted and it shouldn't be used");
                                            j+=3;
                                            index = j;
                                        ...
                                        else if(lines[i].charAt(j) ==' ')
                                        {
                                            ...
                                            try {
                                                ...
                                                outstr.write(buff, index, lines[i].length());
                                                outstr.flush();
                                            } catch (final IOException e) {
                                                end_loop = true;
                                            }
     ...
     *                         RECEIVED_WONT, RECEIVED_COMMAND)
